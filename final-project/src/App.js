...
<>
        ...
        <span> {stateA.name} is {stateA.age}.</span>
      </>
      <br></br>
      <>
        <input
          ...
          onChange={handleInputChangeB}
        />
        <button onClick={handleButtonClickB}>
          Increment age
        </button>
        <span> {stateB.name} is {stateB.age}.</span>
      </>
      */